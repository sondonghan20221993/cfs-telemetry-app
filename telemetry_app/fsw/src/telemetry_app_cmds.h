...
/**
 * @file
 *   This file contains the prototypes for the Telemetry App Ground Command-handling functions
 */

#ifndef TELEMETRY_APP_CMDS_H
#define TELEMETRY_APP_CMDS_H
